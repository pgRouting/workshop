...
* :ref:`dijkstraCost`
  ...
  * :ref:`Exercise 5 <exercise-5>`  Many Pedestrians going to different destinations interested only on the aggregate cost.
...
Description of the parameters can be found in `pgr_dijkstra <http://docs.pgrouting.org/latest/en/src/dijkstra/doc/pgr_dijkstra.html#description-of-the-signatures>`_ documentation.
