...
* *Daniel Kastl* is founder and CEO of `Georepublic <http://georepublic.de>`_ and works in Germany and Japan. He is moderating and promoting the pgRouting community and development since 5 years, and he's an active OSM contributor in Japan.
...
Daniel and Frédéric are the authors of the previous pgRouting workshops, that have been held at FOSS4G events in Canada, South Africa, Spain and at local conferences in Japan.
